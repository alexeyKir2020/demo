...
class MailResetPasswordNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line(Lang::get('Ссылка на изменение пароля действительна в течение :count минут.', ['count' => config('auth.passwords.users.expire')]))
            ->line(Lang::get('Если вы не делали запрос на изменение пароля, просто проигнорируйте это сообщение.'));
    }
